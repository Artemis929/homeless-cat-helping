...
public class VolunteerDao {
    public static void insert(Volunteer Volunteer){
        ...
        try{
            ...
            pstmt.setString(2,Volunteer.getVolunteerSecret());
            pstmt.setString(3,Volunteer.getVolunteerName());
            pstmt.executeUpdate();
        }catch(Exception e){
            e.printStackTrace();
        }finally{
    ...
    private static List<Volunteer> fillResult(String sql)throws SQLException, ClassNotFoundException{
