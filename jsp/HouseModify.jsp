...
<head>
    ...
    <style>
        ...
        .centered-heading {
            ...
            font-size: 16px; /* 字体大小 */
            line-height: 1.2; /* 行高 */
            margin-top: 50px; /* 上边距，使标题与页面顶部有些距离 */
    ...
    <script type="text/javascript">
        var message1 = '<%= (Boolean) request.getAttribute("submitSuccess") ==true ?  request.getAttribute("homemodifyright").toString() : request.getAttribute("errorhomemodify").toString()%>';
...
<main>
    <h1>修改猫屋信息</h1>
    <h3 class="centered-heading">${requestScope.homemodifyright}${requestScope.errorhomemodify}</h3>
    <form id="modify-cat-house-form"  action="./HouseModify" method="get" >
        <div class="form-group">
            <label for="house-id">猫屋ID:</label>
            <input type="text" id="house-id" name="house-id" placeholder="请输入需要修改信息的猫屋ID" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="address" name="address" rows="3" placeholder="请输入猫屋的具体地址"></textarea>
        </div>
        <div class="form-buttons">
            <button type="submit">确认</button>
            <button type="reset">重置</button>
        </div>
        <div id="alert-section" class="alert alert-danger" role="alert" style="display:none;">
            修改猫屋信息时出错，请稍后再试！
        </div>
    </form>
</main>
