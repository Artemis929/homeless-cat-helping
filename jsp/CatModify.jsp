...
<head>
    ...
    <script type="text/javascript">
        var message1 = '<%= (Boolean) request.getAttribute("submitSuccess") ==true ?  request.getAttribute("finishmodify").toString() : request.getAttribute("errornot").toString()%>';
...
<main style="background: url(./imge/bg2.jpg) no-repeat center center;">
    <h1>修改流浪猫界面</h1>
    <h6>${requestScope.finishmodify}</h6>
    <form id="catAdd" action="./CatModify" method="get">
        <div class="form-group">
            <label for="CatID">小猫ID:</label>
            <input type="text" id="CatID" name="CatID" placeholder="需要修改信息的小猫ID" required>
        </div>
        <div class="form-group">
            <label for="CatName">小猫昵称:</label>
            <input type="text" id="CatName" name="CatName" placeholder="请输入小猫昵称！">
        </div>
        <div class="form-group">
