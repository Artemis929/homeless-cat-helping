...
<%@ page import="util.AlipayUtil" %>
<%
	//获得初始化的AlipayClient
	AlipayClient alipayClient = new DefaultAlipayClient(AlipayUtil.gatewayUrl, AlipayUtil.app_id,AlipayUtil.merchant_private_key, "json", AlipayUtil.charset,AlipayUtil.alipay_public_key,AlipayUtil.sign_type);
